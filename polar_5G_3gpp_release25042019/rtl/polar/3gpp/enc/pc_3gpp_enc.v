...
(
  ...
  localparam int cIBUF_WADDR_W  = clogb2(pN_MAX)   ;
  localparam int cIBUF_WDAT_W   = 1                ;

  localparam int cIBUF_RADDR_W  = clogb2(pN_MAX/8) ;
  localparam int cIBUF_RDAT_W   = 8                ;

  localparam int cOBUF_RADDR_W  = cWORD_ADDR_W + clogb2(pWORD_W/pODAT_W);
