...
(
  ...
  always_comb begin
    ...
    case (state)
      ...
      //
      cEPOLY_STEP_STATE : state_next = cnt_done       ? cEPOLY_DONE_STATE : cEPOLY_STEP_STATE;
      cEPOLY_DONE_STATE : state_next = eras_is_zero   ? cBM_INIT_STATE    : cOMEGA_STEP_STATE;
      //
      cOMEGA_STEP_STATE : state_next = cnt_r_done     ? cBM_INIT_STATE    : cOMEGA_STEP_STATE;
      //
      cBM_INIT_STATE    : state_next = eras_is_max    ? cWAIT_STATE       : cBM_STEP_STATE;
      cBM_STEP_STATE    : state_next = cnt_done       ? cWAIT_STATE       : cBM_STEP_STATE;
    endcase
  end
