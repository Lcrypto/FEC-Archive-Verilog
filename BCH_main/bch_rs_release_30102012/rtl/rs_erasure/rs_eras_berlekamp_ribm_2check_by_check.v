...
// Date          : $Date$
// Workfile      : rs_eras_berlekamp_ribm_2check.v
...
(
  ...
  always_comb begin
    ...
    case (state)
      cWAIT_STATE       : state_next = isyndrome_val              ? cEPOLY_STEP_STATE : cWAIT_STATE;
      //
      cEPOLY_STEP_STATE : state_next = (cnt_done    & tcnt_done)  ? cEPOLY_DONE_STATE : cEPOLY_STEP_STATE;
      cEPOLY_DONE_STATE : state_next = eras_is_zero               ? cBM_INIT_STATE    : cOMEGA_STEP_STATE;
      //
      cOMEGA_STEP_STATE : state_next = (cnt_r_done  & tcnt_done)  ? cBM_INIT_STATE    : cOMEGA_STEP_STATE;
      //
      cBM_INIT_STATE    : state_next = eras_is_max                ? cWAIT_STATE       : cBM_STEP_STATE;
      cBM_STEP_STATE    : state_next = (cnt_done    & tcnt_done)  ? cWAIT_STATE       : cBM_STEP_STATE;
    endcase
  end
