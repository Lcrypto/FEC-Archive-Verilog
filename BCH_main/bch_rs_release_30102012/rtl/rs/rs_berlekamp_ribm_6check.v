...
// Date          : $Date$
// Workfile      : rs_berlekamp_ribm_6check.v
...
`endif
  ...
  always_comb begin
    ...
    case (state)
      ...
      cSTEP1_STATE : state_next = ff            ? cSTEP2_STATE                            : cSTEP1_STATE;
      cSTEP2_STATE : state_next = ff            ? cSTEP3_STATE                            : cSTEP2_STATE;
      cSTEP3_STATE : state_next = ff            ? (cnt_done ? cWAIT_STATE : cSTEP1_STATE) : cSTEP3_STATE;
    endcase
  end
