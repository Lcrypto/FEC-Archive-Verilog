/*
  ...
  trel_statem_t   tcm_dec_trb__istatem      [64] ;
  trel_decision_t tcm_dec_trb__idecision    [64] ;
...
(
  ...
  logic           ctrl__owsop              ;
  logic           ctrl__oweop              ;
  trel_decision_t ctrl__owdecision    [64] ;
  ...
  logic           engine__irsop              ;
  logic           engine__ireop              ;
  trel_decision_t engine__irdecision    [64] ;
