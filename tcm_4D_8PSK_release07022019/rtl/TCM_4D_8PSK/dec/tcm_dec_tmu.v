...
(
  ...
  output logic            oeop                ;
  //
  output trel_bm_t        obm           [16]  ; // selected branch metric from 4D symbol for trellis
  //
  ...
  `include "tcm_symb_m_group_tab.vh"
