/*
  ...
  logic         [1 : 0] rsc_dec_output_buffer__ifwdat   ;
  logic [pADDR_W-1 : 0] rsc_dec_output_buffer__ibwaddr  ;
  logic         [1 : 0] rsc_dec_output_buffer__ibwdat   ;
  ...
  logic         [1 : 0] rsc_dec_output_buffer__ordata   ;
...
// Workfile      : rsc_dec_output_buffer.v
...
(
  ...
  input  logic         [1 : 0] ifwdat   ;
  input  logic [pADDR_W-1 : 0] ibwaddr  ;
  input  logic         [1 : 0] ibwdat   ;
  ...
  localparam int cDWC_W   = clogb2(pRDAT_W/2);
