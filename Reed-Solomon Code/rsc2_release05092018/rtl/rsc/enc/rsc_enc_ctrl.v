/*
  ...
  logic            rsc_enc_ctrl__ifull        ;
  logic            rsc_enc_ctrl__orempty      ;
  ...
  (
    ...
    .iN           ( rsc_enc_ctrl__iN           ) ,
    .ifull        ( rsc_enc_ctrl__ifull        ) ,
    .orempty      ( rsc_enc_ctrl__orempty      ) ,
...
(
  ...
  state_t state /* synthesis syn_encoding = "sequential" */;
  ...
  always_ff @(posedge iclk or posedge ireset) begin
    if (ireset) begin
      ...
      case (state)
        cRESET_STATE      : state <= ifull ? cWAIT_STATE : cRESET_STATE;
  ...
  assign orempty      = idbsclk & cnt.done & (state == (nopw ? cPY_STATE : cPW_STATE));
